...
// this method sets the sliders when a textbox is edited
{
    ...
    if ([[netPortLabel stringValue] length] == 0) { [netPortLabel setStringValue:@"29070"]; }
    ...
    if ([[invulnerabilityTimeLabel stringValue] length] == 0) { [invulnerabilityTimeLabel setStringValue:@"10"]; }
    ...
    if ([[setMuteMessages stringValue] length] == 0) { [setMuteMessages setStringValue:@"4"]; }
    if ([[setUnmuteTime stringValue] length] == 0) { [setUnmuteTime setStringValue:@"10"]; }
